...
>>>>>>> cf13f69b539345ab8cd1a0cedceb5577e6cd83bf
...
\\
\\
\textbf{Anforderung:} Die Anwendung reagiert weiterhin auf Benutzereingaben, wenn längere Berechnungen anstehen. 
\\
\textbf{Beschreibung:} Da bei uns keine langen Berechnungen durchgeführt werden, sind Eingaben durch den Benutzer in dem Moment möglich, in dem er sie tätigen möchte.
\\
\\
...
\\
\textbf{Beschreibung:} Aus Zeitgründen wurde die Standartlogik verwendet und implementiert.
