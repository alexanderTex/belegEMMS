...
#include "../include/gui/LoadMenu.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoadMenu_t, stringdata0) + ofs \
...
void *LoadMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoadMenu.stringdata0))
