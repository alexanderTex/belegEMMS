...
#include "../../include/gui/GameView.h"
...
QT_MOC_LITERAL(3, 20, 9), // "GameData*"
QT_MOC_LITERAL(4, 30, 4), // "data"
QT_MOC_LITERAL(5, 35, 9) // "PauseMenu"

    },
    "GameView\0GameEnded\0\0GameData*\0data\0"
    "PauseMenu"
};
...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GameEnded((*reinterpret_cast< GameData*(*)>(_a[1]))); break;
        case 1: _t->PauseMenu(); break;
        default: ;
        }
        ...
        {
            typedef void (GameView::*_t)(GameData * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameView::GameEnded)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameView::PauseMenu)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameView::GameEnded(GameData * _t1)
{
