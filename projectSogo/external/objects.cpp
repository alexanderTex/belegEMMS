...
static void createWireCube()
{
    ...
    f->glEnableVertexAttribArray(0); // Kein Disable ausführen !
...
static void createCube()
{
    ...
    f->glBindBuffer(GL_ARRAY_BUFFER, colorbuffer);
    f->glEnableVertexAttribArray(1); // Kein Disable ausführen !
    f->glVertexAttribPointer(
...
void drawCube()
{
	...
	// Draw the triangles !
    f->glBindVertexArray(VertexArrayIDSolidCube);
    f->glDrawArrays(GL_TRIANGLES, 0, 12*3); // 12*3 indices starting at 0 -> 12 triangles
}
