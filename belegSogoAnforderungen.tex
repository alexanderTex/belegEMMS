...
In diesem Projekt geht es um das Spiel \textit{Sogo}. Dieses soll mit Hilfe von Qt implementiert werden. Die grundlegende Spielumgebung sieht wie folgt aus:
\begin{itemize}
	...
	\item Um die Koordination innerhalb des Rasters zu ermöglichen wird die Grundfläche mittels Hexadezimal-Notation(0-9, A-F) aufgeteilt und die vier Ebenen von eins bis vier durchnummeriert. Daraus ergeben sich folgende Notationen {(0,1),(f,4),...}, wobei die erste Zahl die Position auf der Grundfläche und die zweite Zahl die Position der Ebene darstellt.
	\item  
\end{itemize}
